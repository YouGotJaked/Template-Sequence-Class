// FILE: sequence2.h
// CLASS PROVIDED: a template class for sequence (part of the namespace main_savitch_5)
// This is the template header file for the project described in Section 5.4
// of "Data Structures and Other Objects Using C++"
//
// MEMBER CONSTANTS for the sequence class:
//
